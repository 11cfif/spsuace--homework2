...
public class TextFilterManagerTest {
    ...
    public void analyzeEmptyFilters() {
        ...
        assertEquals("GOOD", manager.analyze("Privet, i Peta :(").toString());
        assertEquals("GOOD", manager.analyze("").toString());
        assertEquals("GOOD", manager.analyze(null).toString());
        assertEquals("GOOD", manager.analyze("Skazite kod iz sms").toString());
        assertEquals("GOOD", manager.analyze("Ooooooocenn dlinnnnnnaaaaaiiii strrooooоoоookkkkaaaaaa").toString());
    }
    ...
    public void analyzeOnlyLongFilter() {
        ...
        assertEquals("GOOD", manager.analyze("").toString());
        assertEquals("GOOD", manager.analyze(null).toString());
        assertEquals("TOO_LONG", manager.analyze("Skazite kod iz sms  ").toString());
        assertEquals("TOO_LONG", manager.analyze("Ooooooocenn dlinnnnnnaaaaaiiii strrooooоoоookkkkaaaaaa").toString());

        manager = new TextFilterManager(new TextAnalyzer[]{TextAnalyzer.createTooLongAnalyzer(0)});
        assertEquals("TOO_LONG", manager.analyze("Privet, i Peta").toString());
        assertEquals("GOOD", manager.analyze("").toString());
        assertEquals("GOOD", manager.analyze(null).toString());
        assertEquals("TOO_LONG", manager.analyze("Skazite kod iz sms  ").toString());
        assertEquals("TOO_LONG", manager.analyze("Ooooooocenn dlinnnnnnaaaaaiiii strrooooоoоookkkkaaaaaa").toString());
    ...
    public void analyzeAllFiltersGood() {
        ...
        assertEquals("GOOD", manager.analyze("").toString());
        assertEquals("GOOD", manager.analyze(null).toString());
        assertEquals("GOOD", manager.analyze("Skazitekodissms:-(").toString());
        assertEquals("GOOD", manager.analyze("sMs plis ;|").toString());
    }
