...
public class TextFilterManagerTest {
    ...
    public void analyzeOnlyCustomFilter() {
        ...
        assertEquals("GOOD", manager.analyze("+79211234567").toString());
        assertEquals("GOOD", manager.analyze("89311234567").toString());
        assertEquals("CUSTOM", manager.analyze("54221234567").toString());
